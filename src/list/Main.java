...
public class Main {
	...
	public static void main(String[] args) {
		System.out.println("-------operate singliy linked list-------");
		operateSinglyLinkedList();
		
		System.out.println("-------operate doubly linked list-------");
		operateDoublyLinkedList();
	}
	
	private static void operateSinglyLinkedList() {
	...
	private static void operateDoublyLinkedList() {
		DoublyLikedList<String> list = new DoublyLikedList<String>();
